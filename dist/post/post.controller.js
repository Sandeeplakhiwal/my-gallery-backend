...
exports.getUserPosts = (0, catchAsyncError_1.catchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _c;
    const user = (_c = req.user) === null || _c === void 0 ? void 0 : _c._id;
    const posts = yield post_model_1.Post.find({ owner: user });
    return res.status(200).json(posts);
}));
exports.deletePost = (0, catchAsyncError_1.catchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _d;
    ...
    if (!post)
        return next(new errorHandler_1.default("Post not found with given id", 404));
    if (post.owner.toString() !== ((_d = req.user) === null || _d === void 0 ? void 0 : _d._id.toString())) {
    ...
    const user = req.user;
    if (user) {
        const indexOfPostId = user === null || user === void 0 ? void 0 : user.posts.indexOf(pId);
