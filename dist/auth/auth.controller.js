...
exports.Signup = (0, catchAsyncError_1.catchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user) {
        return next(new errorHandler_1.default("User already exist with this email address", 409));
    }
    ...
    return (0, sendToken_1.sendToken)(res, user, "Registered successfully", 201);
}));
// Login Controller
exports.Login = (0, catchAsyncError_1.catchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, sendToken_1.sendToken)(res, user, `Welcome back ${user.name}`, 200);
}));
// Logout Controller
...
// Get User Profile
exports.getUserProfile = (0, catchAsyncError_1.catchAsyncError)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const user = yield user_model_1.User.findById((_a = req.user) === null || _a === void 0 ? void 0 : _a._id).populate("posts");
